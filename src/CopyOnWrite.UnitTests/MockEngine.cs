...
// Adapted from https://github.com/dotnet/msbuild/blob/main/src/Shared/UnitTests/MockEngine.cs
...
{
    private readonly object _lockObj = new ();  // Protects _log, _output
    ...
    private readonly ConcurrentQueue<BuildErrorEventArgs> _errorEvents = new ();
    private readonly ConcurrentQueue<BuildWarningEventArgs> _warningEvents = new ();
        ...
        bool unloadProjectsOnCompletion)
    {
        ...
        BuildEngineResult result = BuildProjectFilesInParallel(projectFileNames, targetNames, globalProperties, new IList<string>[projectFileNames.Length], toolsVersion, includeTargetOutputs);
    ...
    /// </summary>
    internal void AssertLogDoesntContainMessageFromResource(GetStringDelegate getString, string resourceName, params object[] parameters)
    {
    ...
    /// </summary>
    internal void AssertLogContainsMessageFromResource(GetStringDelegate getString, string resourceName, params object[] parameters)
    {
        string resource = getString(resourceName);
        string stringToSearchFor = String.Format(resource, parameters);
